...
argument-hint: --platform <vscode|claude-code|cursor> --output <path> [--output-vscode <path>] [--output-claude <path>] [--output-cursor <path>]
---
...
5. **Generate Context7 skills installation scripts** – Create `scripts/install-context7-skills.sh` and `scripts/install-context7-skills.ps1` with detected skills
6. **Recommend Context7 skills** – Output a summary of recommended Context7 skills based on detected patterns
7. **Skills** – Copy all relevant skills from `skill-templates/` to `.claude/skills/`
8. **Update orchestrator** – Fill in `{{active_agents_table}}` with generated agents
9. **Create docs/planning/** – Create the planning directory structure
