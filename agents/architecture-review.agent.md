...
description: Use this agent to review code for architectural consistency and patterns. Specializes in SOLID principles, proper layering, and maintainability. Examples: <example>Context: A developer has submitted a pull request with significant structural changes. user: 'Please review the architecture of this new feature.' assistant: 'I will use the Architecture Review Agent to ensure the changes align with our existing architecture.' <commentary>Architectural reviews are critical for maintaining a healthy codebase, so the Architecture Review Agent is the right choice.</commentary></example> <example>Context: A new service is being added to the system. user: 'Can you check if this new service is designed correctly?' assistant: 'I'll use the Architecture Review Agent to analyze the service boundaries and dependencies.' <commentary>The Architecture Review Agent can validate the design of new services against established patterns.</commentary></example>
tools: [execute, read, edit/editFiles, search, todo]
